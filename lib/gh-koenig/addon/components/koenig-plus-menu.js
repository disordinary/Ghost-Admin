...
export default Component.extend({
    ...
    didRender() {
        ...
        editor.cursorDidChange(() => {
            ...
            let editorOffset = holder.offset();
            ...
            run.schedule('afterRender', this,
                () => {
                    ...
                    button.css('top', offset.top + holder.scrollTop() - editorOffset.top - 2);
                    if(isInRunLoop) {
                        run.end();
                    }
                });
        ...
        openMenu: function () { // eslint-disable-line
            ...
            run.schedule('afterRender', this,
                () => {
                    ...
                    let hiddenByOverflow = (holder.innerHeight() + holder.scrollTop()) - (menu.height() + top);
